(define (domain rover)
  ...
  (:action communicate_soil_data
    ...
    :effect
      (and (communicated_soil_data ?p) (not (available ?r)) (not (channel_free ?l)))
  )
  ...
  (:action communicate_rock_data
    ...
    :effect
      (and (communicated_rock_data ?p) (not (available ?r)) (not (channel_free ?l)))
  )
  ...
  (:action communicate_image_data
    ...
    :effect
      (and (communicated_image_data ?o ?m) (not (available ?r)) (not (channel_free ?l)))
  )
)
