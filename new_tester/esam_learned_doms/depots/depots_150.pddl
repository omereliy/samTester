...
(define (domain depot)
    ...
    (:action drop_1
     ...
     :precondition (and (clear ?x2) (at ?x0 ?x3) (at ?x2 ?x3) (lifting ?x0 ?x1))
     :effect (and
        (on ?x1 ?x2)
        (at ?x1 ?x3)
        (clear ?x1)
    ...
    (:action unload_1
     :parameters (?x0 - hoist ?x1 - crate ?x2 - truck ?x3 - place)
     :precondition (and (in ?x1 ?x2) (available ?x0) (at ?x0 ?x3) (at ?x2 ?x3))
     :effect (and
        (lifting ?x0 ?x1)
        (not (in ?x1 ?x2))
        (not (available ?x0)))
    ...
    (:action lift_1
     :parameters (?x0 - hoist ?x1 - crate ?x2 - surface ?x3 - place)
     :precondition (and (on ?x1 ?x2) (at ?x1 ?x3) (at ?x2 ?x3) (at ?x0 ?x3) (available ?x0) (clear ?x1))
     :effect (and
        (clear ?x2)
        (lifting ?x0 ?x1)
        (not (clear ?x1))
