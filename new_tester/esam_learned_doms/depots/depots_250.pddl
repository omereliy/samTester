...
(define (domain depot)
    ...
    (:action unload_1
     ...
     :precondition (and (available ?x0) (at ?x0 ?x3) (at ?x2 ?x3) (in ?x1 ?x2))
     :effect (and
        (lifting ?x0 ?x1)
        (not (available ?x0))
        (not (in ?x1 ?x2)))
    ...
    (:action drop_1
     ...
     :precondition (and (at ?x0 ?x3) (lifting ?x0 ?x1) (at ?x2 ?x3) (clear ?x2))
     :effect (and
        (available ?x0)
        (at ?x1 ?x3)
        (on ?x1 ?x2)
    ...
    (:action load_1
     :parameters (?x0 - hoist ?x1 - crate ?x2 - truck ?x3 - place)
     :precondition (and (at ?x0 ?x3) (lifting ?x0 ?x1) (at ?x2 ?x3))
     :effect (and
        (available ?x0)
        (in ?x1 ?x2)
        (not (lifting ?x0 ?x1)))
    ...
    (:action lift_1
     :parameters (?x0 - hoist ?x1 - crate ?x2 - surface ?x3 - place)
     :precondition (and (on ?x1 ?x2) (at ?x0 ?x3) (at ?x2 ?x3) (clear ?x1) (at ?x1 ?x3) (available ?x0))
     :effect (and
        (clear ?x2)
        (lifting ?x0 ?x1)
        (not (on ?x1 ?x2))
