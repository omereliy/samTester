...
(define (domain rover)
    ...
    (:action communicate_rock_data_2
     ...
     :precondition (and (at_soil_sample ?x3) (have_rock_analysis ?x0 ?x2) (channel_free ?x1) (visible ?x3 ?x2) (at_lander ?x1 ?x3) (equipped_for_imaging ?x0) (at_soil_sample ?x2) (at ?x0 ?x2) (available ?x0) (equipped_for_rock_analysis ?x0) (equipped_for_soil_analysis ?x0) (visible ?x2 ?x3))
     :effect (and
    ...
    (:action communicate_rock_data_3
     ...
     :precondition (and (at_soil_sample ?x3) (have_rock_analysis ?x0 ?x3) (equipped_for_soil_analysis ?x0) (at ?x0 ?x3) (visible ?x3 ?x4) (have_rock_analysis ?x0 ?x2) (channel_free ?x1) (equipped_for_imaging ?x0) (visible ?x4 ?x2) (at_soil_sample ?x2) (visible ?x4 ?x3) (at ?x0 ?x2) (available ?x0) (visible ?x2 ?x4) (at_soil_sample ?x4) (equipped_for_rock_analysis ?x0) (at_lander ?x1 ?x4) (communicated_rock_data ?x3))
     :effect (and
        (communicated_rock_data ?x2))
    )
    ...
    (:action sample_rock_1
     ...
     :precondition (and (equipped_for_imaging ?x0) (empty ?x1) (at_soil_sample ?x2) (available ?x0) (equipped_for_rock_analysis ?x0) (at ?x0 ?x2) (equipped_for_soil_analysis ?x0) (at_rock_sample ?x2) (store_of ?x1 ?x0))
     :effect (and
        (full ?x1)
    ...
    (:action communicate_rock_data_1
     :parameters (?x0 - rover ?x1 - lander ?x2 - waypoint ?x3 - waypoint ?x4 - waypoint)
     :precondition (and (at_soil_sample ?x3) (have_rock_analysis ?x0 ?x3) (equipped_for_soil_analysis ?x0) (at ?x0 ?x3) (visible ?x3 ?x4) (have_rock_analysis ?x0 ?x2) (channel_free ?x1) (equipped_for_imaging ?x0) (visible ?x4 ?x2) (at_soil_sample ?x2) (visible ?x4 ?x3) (at ?x0 ?x2) (available ?x0) (visible ?x2 ?x4) (at_soil_sample ?x4) (equipped_for_rock_analysis ?x0) (at_lander ?x1 ?x4) (communicated_rock_data ?x2))
     :effect (and
    ...
    (:action navigate_1
     ...
     :precondition (and (equipped_for_soil_analysis ?x0) (can_traverse ?x0 ?x2 ?x1) (equipped_for_imaging ?x0) (visible ?x1 ?x2) (visible ?x2 ?x1) (equipped_for_rock_analysis ?x0) (available ?x0) (can_traverse ?x0 ?x1 ?x2) (have_soil_analysis ?x0 ?x1) (at ?x0 ?x1))
     :effect (and
        (at ?x0 ?x2)
        (not (at ?x0 ?x1)))
    )
    ...
    (:action sample_soil_1
     :parameters (?x0 - rover ?x1 - store ?x2 - waypoint)
     :precondition (and (equipped_for_imaging ?x0) (empty ?x1) (at_soil_sample ?x2) (available ?x0) (equipped_for_rock_analysis ?x0) (at ?x0 ?x2) (equipped_for_soil_analysis ?x0) (store_of ?x1 ?x0))
     :effect (and
        (full ?x1)
    ...
    (:action communicate_soil_data_1
     :parameters (?x0 - rover ?x1 - lander ?x2 - waypoint ?x3 - waypoint ?x4 - waypoint)
     :precondition (and (have_soil_analysis ?x0 ?x3) (can_traverse ?x0 ?x4 ?x3) (have_soil_analysis ?x0 ?x2) (at ?x0 ?x3) (visible ?x3 ?x4) (can_traverse ?x0 ?x3 ?x4) (channel_free ?x1) (equipped_for_imaging ?x0) (visible ?x4 ?x2) (visible ?x4 ?x3) (available ?x0) (equipped_for_rock_analysis ?x0) (visible ?x2 ?x4) (at_soil_sample ?x4) (equipped_for_soil_analysis ?x0) (at_lander ?x1 ?x4))
     :effect (and
    ...
    (:action calibrate_1
     ...
     :precondition (and (at_soil_sample ?x3) (equipped_for_soil_analysis ?x0) (at ?x0 ?x3) (equipped_for_imaging ?x0) (available ?x0) (equipped_for_rock_analysis ?x0) (visible_from ?x2 ?x3) (calibration_target ?x1 ?x2) (on_board ?x1 ?x0))
     :effect (and
        (calibrated ?x1 ?x0))
    )
