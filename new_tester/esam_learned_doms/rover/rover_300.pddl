...
(define (domain rover)
    ...
    (:action take_image_1
     ...
     :precondition (and (calibrated ?x3 ?x0) (equipped_for_imaging ?x0) (visible_from ?x2 ?x1) (on_board ?x3 ?x0) (available ?x0) (supports ?x3 ?x4) (at ?x0 ?x1))
     :effect (and
        (have_image ?x0 ?x2 ?x4)
    ...
    (:action communicate_image_data_1
     ...
     :precondition (and (at_lander ?x1 ?x5) (channel_free ?x1) (equipped_for_imaging ?x0) (have_image ?x0 ?x2 ?x3) (at ?x0 ?x4) (can_traverse ?x0 ?x5 ?x4) (visible ?x5 ?x4) (equipped_for_rock_analysis ?x0) (available ?x0) (visible ?x4 ?x5) (can_traverse ?x0 ?x4 ?x5))
     :effect (and
    ...
    (:action communicate_rock_data_1
     :parameters (?x0 - rover ?x1 - lander ?x2 - waypoint ?x3 - waypoint ?x4 - waypoint)
     :precondition (and (at ?x0 ?x3) (visible ?x3 ?x4) (have_rock_analysis ?x0 ?x2) (channel_free ?x1) (visible ?x4 ?x3) (available ?x0) (equipped_for_rock_analysis ?x0) (at_lander ?x1 ?x4))
     :effect (and
    ...
    (:action drop_1
     ...
     :precondition (and (full ?x1) (available ?x0) (store_of ?x1 ?x0))
     :effect (and
        (empty ?x1)
        (not (full ?x1)))
    )
    ...
    (:action sample_rock_1
     ...
     :precondition (and (empty ?x1) (at ?x0 ?x2) (available ?x0) (equipped_for_rock_analysis ?x0) (at_rock_sample ?x2) (store_of ?x1 ?x0))
     :effect (and
        (full ?x1)
    ...
    (:action calibrate_1
     ...
     :precondition (and (at ?x0 ?x3) (equipped_for_imaging ?x0) (available ?x0) (visible_from ?x2 ?x3) (calibration_target ?x1 ?x2) (on_board ?x1 ?x0))
     :effect (and
        (calibrated ?x1 ?x0))
    )
