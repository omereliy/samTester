...
(define (domain rover)
    ...
    (:action take_image_1
     ...
     :precondition (and (calibrated ?x3 ?x0) (equipped_for_imaging ?x0) (visible_from ?x2 ?x1) (on_board ?x3 ?x0) (available ?x0) (equipped_for_rock_analysis ?x0) (supports ?x3 ?x4) (at ?x0 ?x1))
     :effect (and
        (have_image ?x0 ?x2 ?x4)
