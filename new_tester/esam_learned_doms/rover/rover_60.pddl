...
(define (domain rover)
    ...
    (:action drop_1
     ...
     :precondition (and (full ?x1) (available ?x0) (equipped_for_soil_analysis ?x0) (store_of ?x1 ?x0))
     :effect (and
        (empty ?x1)
        (not (full ?x1)))
    )
    ...
    (:action communicate_image_data_1
     ...
     :precondition (and (at_lander ?x1 ?x5) (channel_free ?x1) (equipped_for_imaging ?x0) (have_image ?x0 ?x2 ?x3) (at ?x0 ?x4) (can_traverse ?x0 ?x5 ?x4) (visible ?x5 ?x4) (equipped_for_rock_analysis ?x0) (available ?x0) (visible ?x4 ?x5) (visible_from ?x2 ?x4) (at_soil_sample ?x5) (can_traverse ?x0 ?x4 ?x5))
     :effect (and
