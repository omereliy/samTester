...
(define (domain satellite)
    ...
    (:action calibrate_1
     ...
     :precondition (and (power_on ?x1) (pointing ?x0 ?x2) (on_board ?x1 ?x0) (calibration_target ?x1 ?x2))
     :effect (and
        (calibrated ?x1))
    )
    ...
    (:action take_image_1
     ...
     :precondition (and (on_board ?x2 ?x0) (pointing ?x0 ?x1) (calibrated ?x2) (power_on ?x2) (supports ?x2 ?x3))
     :effect (and
        (have_image ?x1 ?x3))
    )
